...
prop_appUn = describe "Utils.Types.UnAppToVal" $ do
  it "Double -> Double instance" $ property prop_appUnDoubleDouble
  it "Bool -> Bool instance" $ property prop_appUnBoolBool
...
prop_appBin = describe "Utils.Types.BinAppToVal" $ do
  ...
  it "Bool -> Bool -> Bool instance" $ property prop_appBinBoolBoolBool
  it "String -> String -> String instance" $ property prop_appBinStrStrStr
  it "Seq Val -> Seq Val -> Seq Val instance" $ property prop_appBinSeqSeqSeq
...
prop_appBinSeqSeqSeq a b =
  case appBin ((<>) :: Seq Val -> Seq Val -> Seq Val) a b of
    ListVal _ -> True
    _         -> False

prop_appBinStrStrStr :: Val -> Val -> Bool
prop_appBinStrStrStr a b =
  case appBin ((<>) :: String -> String -> String) a b of
    StrVal _ -> True
    _        -> False
